        ...
        <section id="vision" className="py-24 border-b border-white/5">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">Our Integrated Vision</h2>
              <p className="text-slate-400 text-lg">Discover how we revolutionize business by unifying security, compliance, and real estate strategy.</p>
            </div>
            <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-slate-900">
              <div className="aspect-video bg-slate-800 flex items-center justify-center">
                <div className="text-center">
                  <p className="text-slate-400">Executive Vision • 60-90 seconds</p>
                  <p className="text-sm text-slate-500 mt-2">Security • Compliance • Realty</p>
                </div>
              </div>
            </div>
          </div>
